...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 *      var oTable = $('#example').dataTable();
		 *
		 *      // Immediately 'nuke' the current rows (perhaps waiting for an Ajax callback/views.)
		 *      oTable.fnClearTable();
		 *    } );
		 */
		 ...
		 *        // /views. do something with the array / object of data for the row
		 *      } );
		 *    } );
		 *
		 *  @example
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sLoadingRecords && zeroRecords &&
			defaults.sLoadingRecords === "Loading/views." )
		{
	...
	function _fnDetectHeader ( aLayout, nThead )
	{
		...
		for ( i=0, iLen=nTrs.length ; i<iLen ; i++ )
		{
			...
			/* For every cell in the row/views. */
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		$(settings.nTable).on( 'search.dt.DT', function ( ev, s ) {
			if ( settings === s ) {
				...
				// inside an iframe or frame/views.
				try {
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( table.outerWidth() < sanityWidth )
		{
			...
			// IE6/7 are a law unto themselves/views.
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			for ( i=0 ; i<visibleColumns.length ; i++ ) {
				...
				// Use getBounding/views. where possible (not IE8-) because it can give
	...
	function _fnSortAria ( settings )
	{
		...
		for ( var i=0, iLen=columns.length ; i<iLen ; i++ )
		{
			...
			// attr() and removeAttr() methods/views.
	 ...
	 *         methodExt: [ /views. ],              -- array    - Array of Api object definitions to extend the method result
	 *         propExt:   [ /views. ]               -- array    - Array of Api object definitions to extend the property
	 *       },
	 *       {
	 *         name:     'row'
	 *         val:       {},
	 ...
	 * @param {array} [/views.] Optional additional sorting conditions
	 * @returns {DataTables.Api} this
	 *//**
	 * Set the ordering for the table.
	 *
	...
	DataTable.defaults = {
		 ...
		 *   // Note DataTables expects data in the form `{ data: [ /views.data/views. ] }` by default).
		 *   $('#example').dataTable( {
		 *     "ajax": "data.json"
		 *   } );
		 *
		 ...
		 *   // `data` to `tableData` (i.e. `{ tableData: [ /views.data/views. ] }`)
		 *   $('#example').dataTable( {
		 *     "ajax": {
		 *       "url": "data.json",
		 *       "dataSrc": "tableData"
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "loadingRecords": "Please wait - loading/views."
			 *        }
			 *      } );
			 *    } );
			 */
			"sLoadingRecords": "Loading/views.",
	...
	$.extend( DataTable.ext.type.detect, [
		...
		// e.g. Date.parse('55') (but not all, e.g. Date.parse('22')/views.).
		function ( d, settings )
		{
	 ...
	 * publicly/views. - To be fixed in 2.0 using methods on the prototype
	 */
