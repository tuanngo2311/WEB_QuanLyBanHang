													...
													<div class="row">
														...
														<div class="col-75">
															<select id="selectID" name="category_id">
																<%
							                                       // ProductDao dao = new ProductDao();
							                                    List<Category> list = dao.fillAllCategories();//gọi fillAllCategories trả về trả về ds Category
							                                        for (Category cate : list) {
							                                            //sau đó dùng for chạy để lấy tất cả
							                                            // lấy option value là cái hiển thị. ds.get(i).getName()lấy tên hiển thị khi ng ta chọn thì bên trong sẽ lấy giá trị
