...
-->
			<div class="logo">
				<a href="dashboard.jsp" class="simple-text"> DashBorad </a>
			</div>
			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href=""> Add User Table </a>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-content">
									<h4 class="card-title">Add User Table</h4>
									<div class="toolbar">
														...
														<div class="row">
															...
															<div class="col-75">
																...
																<span class="badge badge-primary shadow-primary m-1"
																	style="font-size: 14px; background: #414d0b">Admin</span>

																<input type="radio" id="fname" name="role" value="0"><span
																	class="badge badge-primary shadow-primary m-1"
																	style="font-size: 14px; background: #545b62">User</span>
															</div>
														</div>

														<input class="inputSubmit" type="submit" id="insertUs" name="_type"
															value="INSERT">
