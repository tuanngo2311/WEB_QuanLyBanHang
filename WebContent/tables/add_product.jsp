...
<!-- Bootstrap core CSS     -->
<link
	href="${pageContext.request.contextPath}/examples/assets/css/bootstrap.min.css"	rel="stylesheet" />
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-content">
									<h4 class="card-title">Add Product Tables</h4>
									<div class="toolbar">
									...
									<div class="material-datatables">
										<table id="datatables"
											...
											<form action = "UploadFile.jsp" method = "post"enctype = "multipart/form-data">
					                            <input type = "file" id = "btnUploadfile" name = "file" size = "50" />
					                            <br />
					                            <input type = "submit" id = "sendUploadfile_file" value = "Upload File" />
					                        </form>
											<%
											...
											%>
												...
												<tr>
													...
													<div class="row">
														...
														<div class="col-75">
															<input type="text" id="fname" name="note"
																placeholder="Note">
														</div>
													</div>
													...
													<input class="inputSubmit" type="submit" id="insertProduct" name="_type" value="INSERT">
												</tr>
												</form>
											</tbody>
										</table>
