						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-content">
									<h4 class="card-title">UsersTables</h4>
									<div class="toolbar">
									...
									<div class="material-datatables">
										<table id="datatables"
											...
											<tbody>
												...
												ArrayList<User> dsuser = userdao.fillAll();
												...
												<tr>
													...
													<td><%=dsuser.get(i).getRole() == 1 ? "Admin" : "Customer"%></td>
													...
													<form method="get" action="../UserController">
														...
														<td class="td-actions text-right">
															...
															<button type="button" rel="tooltip"
																class="btn btn-info btn-simple" data-original-title=""
																title="person">
																<i class="material-icons">person</i>
															</button>
															<button type="submit" rel="tooltip"
																class="btn btn-success btn-simple" id="update_user" name="_type"
																value="UPDATE" data-original-title="" title="update">
																<i class="material-icons">update</i>
															</button>

															<button type="submit" rel="tooltip"
																class="btn btn-danger btn-simple" id="delete_user" name="_type"
																value="DELETE" data-original-title="" title="delete">
																<i class="material-icons">delete</i>
															</button> 
															<input type="hidden" name="userid"
															value="<%=dsuser.get(i).getId()%>" />
														</td>
													</form>
												</tr>
												<%}%>
